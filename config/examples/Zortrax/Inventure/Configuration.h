...
#define STRING_CONFIG_H_AUTHOR "(m4cias, Zortrax Inventure)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZORTRAX_INVENTURE
#endif
 ...
 */
#define SERIAL_PORT 6 // (DEBUG header)
