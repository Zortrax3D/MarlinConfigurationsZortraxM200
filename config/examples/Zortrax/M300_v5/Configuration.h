...
#define STRING_CONFIG_H_AUTHOR "(m4cias, Zortrax M300 V05)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Zortrax M300 V05"
...
#define X_BED_SIZE 300.0
#define Y_BED_SIZE 300.0
